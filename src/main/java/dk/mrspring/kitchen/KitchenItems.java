...
public class KitchenItems
{
    ...
    public static final Item book = new ItemBook("recipe_book").setLocalizableName("Chef Master Guide").setInformationLines(new String[] { "From Novice to Expert in 5 minutes!" });
